...
import com.mozhimen.imagek.ucrop.commons.BitmapCropCallback;
import com.mozhimen.imagek.ucrop.mos.AspectRatio;
import com.mozhimen.imagek.ucrop.utils.FileUtils;
import com.mozhimen.imagek.ucrop.widgets.CropImageView;
import com.mozhimen.imagek.ucrop.widgets.GestureCropImageView;
import com.mozhimen.imagek.ucrop.widgets.OverlayView;
import com.mozhimen.imagek.ucrop.widgets.TransformImageView;
import com.mozhimen.imagek.ucrop.widgets.UCropView;
...
public class UCropActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == com.mozhimen.imagek.matisse.R.id.button_complete) {
            cropAndSaveImage();
        } else if (id == com.mozhimen.imagek.matisse.R.id.button_back) {
            onBackPressed();
        }
    }
...
//        exitAnimation();
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        if (inputUri != null && outputUri != null) {
            ...
            setResultError(new NullPointerException(getString(com.mozhimen.imagek.ucrop.R.string.ucrop_error_input_data_is_absent)));
            closeActivity();
        }
    }
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setDimmedColor(intent.getIntExtra(UCrop.Options.EXTRA_DIMMED_LAYER_COLOR, getResources().getColor(com.mozhimen.imagek.ucrop.R.color.ucrop_color_default_dimmed)));
        ...
        mOverlayView.setCropFrameColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_FRAME_COLOR, getResources().getColor(com.mozhimen.imagek.ucrop.R.color.ucrop_color_default_crop_frame)));
        mOverlayView.setCropFrameStrokeWidth(intent.getIntExtra(UCrop.Options.EXTRA_CROP_FRAME_STROKE_WIDTH, getResources().getDimensionPixelSize(com.mozhimen.imagek.ucrop.R.dimen.ucrop_default_crop_frame_stoke_width)));

        mOverlayView.setShowCropGrid(intent.getBooleanExtra(UCrop.Options.EXTRA_SHOW_CROP_GRID, OverlayView.DEFAULT_SHOW_CROP_GRID));
        mOverlayView.setCropGridRowCount(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_ROW_COUNT, OverlayView.DEFAULT_CROP_GRID_ROW_COUNT));
        mOverlayView.setCropGridColumnCount(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_COLUMN_COUNT, OverlayView.DEFAULT_CROP_GRID_COLUMN_COUNT));
        mOverlayView.setCropGridColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_COLOR, getResources().getColor(com.mozhimen.imagek.ucrop.R.color.ucrop_color_default_crop_grid)));
        mOverlayView.setCropGridStrokeWidth(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_STROKE_WIDTH, getResources().getDimensionPixelSize(com.mozhimen.imagek.ucrop.R.dimen.ucrop_default_crop_grid_stoke_width)));
...
//        exitAnimation();
    ...
    protected void exitAnimation() {
        ...
        overridePendingTransition(com.mozhimen.imagek.ucrop.R.anim.ucrop_anim_fade_in, exitAnimation != 0 ? exitAnimation : com.mozhimen.imagek.ucrop.R.anim.ucrop_anim_close);
    }
}
