package com.mozhimen.imagek.ucrop.uis;
...
import com.mozhimen.imagek.ucrop.R;
import com.mozhimen.imagek.ucrop.UCrop;
import com.mozhimen.imagek.ucrop.UCropMulti;
import com.mozhimen.imagek.ucrop.commons.BitmapCropCallback;
import com.mozhimen.imagek.ucrop.utils.immersion.CropImmersiveManager;
import com.mozhimen.imagek.ucrop.mos.AspectRatio;
import com.mozhimen.imagek.ucrop.mos.CutInfo;
import com.mozhimen.imagek.ucrop.utils.FileUtils;
import com.mozhimen.imagek.ucrop.utils.VersionUtils;
...
public class PictureMultiCuttingActivity extends AppCompatActivity {
    ...
    public void immersive() {
        CropImmersiveManager.immersiveAboveAPI23(this
                , mStatusBarColor
                , mToolbarColor
                , openWhiteStatusBar);
    }
    ...
    private void addPhotoRecyclerView() {
        ...
        mRecyclerView.setId(R.id.ucrop_id_recycler);
        ...
        ((RelativeLayout.LayoutParams) uCropFrame.getLayoutParams())
                .addRule(RelativeLayout.ABOVE, R.id.ucrop_id_recycler);
    }
